   ...
   <head>
       ...
       <div class="cont-head">
        ...
        <nav class="menu">
            <ul>
                ...
                <li><a href="#">Lista Incidencias</a></li>
    ...
    <form  method="post">
       <label for="">Por Asunto:</label>
        ...
        <label for="" class="label-in">Filtrar por:</label>
        ...
        <!---------------------------DATOS--------------------------->
             ...
             while($verticket = $resultado->fetch_array(MYSQLI_BOTH))
             {
                 echo'<tr>
                        ...
                        <th class="filas"><a href="edit-ticket-tec.php?id='.$verticket['idticket'].'"><button type="submit" class="buttons"> Editar </button></a></th>
                        <th class="filas"><a href="generar-informe.php?id='.$verticket['idticket'].'"><button type="submit" class="buttons"> Generar Informe </button></a></th>
                      </tr>';
             }
             ?>
         </table>
